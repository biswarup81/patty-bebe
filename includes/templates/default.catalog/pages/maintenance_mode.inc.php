...
<div id="box-maintenance-mode">
  <img src="<?php echo WS_DIR_IMAGES; ?>logotype.png" style="max-width: 380px; max-height: 60px;" alt="<?php echo settings::get('store_name'); ?>" title="<?php echo settings::get('store_name'); ?>" />
  <hr />
