      ...
      if (settings::get('security_blacklist')) {
        if (self::is_blacklisted()) {
          ...
          die('<html>' . PHP_EOL
            ...
            . '  We take all spam, hacking, hijacking, and intrusion attempts seriously.</p>' . PHP_EOL
            . '<p>If this was not you, then your computer or router could be infected with malware and part by a a botnet.</p>' . PHP_EOL
